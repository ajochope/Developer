...
- (void) notify
{
    // emitimos el objeto recepcionChat
    // proceso de difusion tipo broadcast
    NSArray *array =
    [[[NSArray alloc] initWithArray:_rMessages] copy];
    [[NSNotificationCenter defaultCenter]
        postNotificationName:@"RecepcionChat" object:array];
}
